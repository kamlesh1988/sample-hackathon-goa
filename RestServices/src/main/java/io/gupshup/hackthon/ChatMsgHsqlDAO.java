...
import io.gupshup.wpp.resources.managers.HsqlDataSource;

public class ChatMsgHsqlDAO extends AbstractGenericDao<Integer, ChatMsgObject> implements DataStoreInterface
{
	public ChatMsgHsqlDAO()
	{
		super(ChatMsgObject.class, HsqlDataSource.getInstance());
	}
