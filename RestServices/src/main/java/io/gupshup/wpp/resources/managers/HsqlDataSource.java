...
public class HsqlDataSource implements ConnectionPool
{
	...
	private void init()
	{
		String databaseUrl = Configurator.getString("hsql.url");
		String username = Configurator.getString("hsql.user");
		String password = Configurator.getString("hsql.password");
		int maxIdle = Integer.parseInt(Configurator.getString("hsql.connection.maxIdle"));
		int maxTotal = Integer.parseInt(Configurator.getString("hsql.connection.maxTotal"));
